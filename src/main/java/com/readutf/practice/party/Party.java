...
//        Menu menu = new Menu(ColorUtil.color("&6Other Parties."), 6);
...
//                        Menu menu = new Menu(ColorUtil.color("&eSelect A kit"), SpigotUtils.roundToNine(KitManager.get().getKits().size()) / 9);
//                        int x = 0;
