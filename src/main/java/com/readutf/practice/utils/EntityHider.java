...
public class EntityHider implements Listener {
     ...
     */
    public final boolean showPlayer(Player observer, Entity entity) {
     ...
     */
    public final boolean hidePlayer(Player observer, Entity entity) {
        validate(observer, entity);
